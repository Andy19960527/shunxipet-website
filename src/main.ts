  ...
  app.innerHTML = `
    ...
    <header class="relative min-h-[600px] md:min-h-[700px] flex flex-col overflow-hidden">
      <div class="absolute inset-0 z-0">
        <img src="https://coze-coding-project.tos.coze.site/coze_storage_7615892821844951067/image/generate_image_800e7262-9c14-4e9d-9b7e-9c9d2cc27dbb.jpeg" alt="Dog and owner" class="w-full h-full object-cover object-top" />
